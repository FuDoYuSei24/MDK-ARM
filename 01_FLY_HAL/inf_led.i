...
void Inf_LED_SetStatus(LedStruct *led){
    ...
    if(led->status<=1){
        if(led->location == LEFT_TOP){
            HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), 
                              ((uint16_t)0x1000), 
                             (GPIO_PinState)(led->status));  
        }
        else if(led->location == LEFT_BOTTOM){
            HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000C00UL)), 
                              ((uint16_t)0x4000), 
                             (GPIO_PinState)(led->status));
        }
        ...
        if(led->location == LEFT_TOP){
            HAL_GPIO_TogglePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), 
                              ((uint16_t)0x1000));  
        }
        else if(led->location == LEFT_BOTTOM){
            HAL_GPIO_TogglePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000C00UL)), 
                              ((uint16_t)0x4000));
        }
        else if(led->location == RIGHT_TOP){
            HAL_GPIO_TogglePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), 
