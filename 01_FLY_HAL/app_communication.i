#line 1 "..\\App\\communication\\App_Communication.c"
#line 1 "..\\App\\communication\\App_Communication.h"
...
#line 4 "..\\App\\communication\\App_Communication.h"
...
#line 5 "..\\App\\communication\\App_Communication.h"
...
#line 6 "..\\App\\communication\\App_Communication.h"
...
#line 2 "..\\App\\communication\\App_Communication.c"
...
void App_Communication_Start(void)
{
    printf("[%15s:%4d] -- " "Communication Module Start..." "\r\n", strrchr("..\\App\\communication\\App_Communication.c", '\\') ? (strrchr("..\\App\\communication\\App_Communication.c", '\\') + 1) : "..\\App\\communication\\App_Communication.c", 8 );

     
    printf("[%15s:%4d] -- " "2.4G Self Check Start..." "\r\n", strrchr("..\\App\\communication\\App_Communication.c", '\\') ? (strrchr("..\\App\\communication\\App_Communication.c", '\\') + 1) : "..\\App\\communication\\App_Communication.c", 11 );
    while(Inf_Si24R1_Check()==1){
        HAL_Delay(500);
    }
    printf("[%15s:%4d] -- " "2.4G Self Check Finished..." "\r\n", strrchr("..\\App\\communication\\App_Communication.c", '\\') ? (strrchr("..\\App\\communication\\App_Communication.c", '\\') + 1) : "..\\App\\communication\\App_Communication.c", 15 );


     
    printf("[%15s:%4d] -- " "Set Communication Module to RX Mode..." "\r\n", strrchr("..\\App\\communication\\App_Communication.c", '\\') ? (strrchr("..\\App\\communication\\App_Communication.c", '\\') + 1) : "..\\App\\communication\\App_Communication.c", 19 );
    Inf_Si24R1_RXMode();
    printf("[%15s:%4d] -- " "Communication Module Started..." "\r\n", strrchr("..\\App\\communication\\App_Communication.c", '\\') ? (strrchr("..\\App\\communication\\App_Communication.c", '\\') + 1) : "..\\App\\communication\\App_Communication.c", 21 );
