#line 1 "..\\Inf\\2_4g\\Inf_Si24R1.c"
#line 1 "..\\Inf\\2_4g\\Inf_Si24R1.h"
...
#line 31 "..\\Inf\\2_4g\\Inf_Si24R1.h"

 

                          
#line 45 "..\\Inf\\2_4g\\Inf_Si24R1.h"

#line 62 "..\\Inf\\2_4g\\Inf_Si24R1.h"
...
#line 2 "..\\Inf\\2_4g\\Inf_Si24R1.c"

uint8_t TX_ADDRESS[5] = {0x0A, 0x01, 0x07, 0x0E, 0x01};   
uint8_t RX_ADDRESS[5] = {0x0A, 0x01, 0x07, 0x0E, 0x01};   
...
uint8_t Inf_Si24R1_WriteReg(uint8_t reg, uint8_t data)
{
    ...
    HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), ((uint16_t)0x0010), GPIO_PIN_RESET);
     
    status = Driver_SPI_SwapByte(reg);
     
    Driver_SPI_SwapByte(data);
     
    HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), ((uint16_t)0x0010), GPIO_PIN_SET);
...
void Inf_Si24R1_TXMode(void)
{
    ...
    HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), ((uint16_t)0x0100), GPIO_PIN_RESET);
     
    Inf_Si24R1_WriteBuf(0x20 + 0x10, TX_ADDRESS, 5);      
    Inf_Si24R1_WriteBuf(0x20 + 0x0A, RX_ADDRESS, 5);   
    Inf_Si24R1_WriteReg(0x20 + 0x01, 0x01);        
    Inf_Si24R1_WriteReg(0x20 + 0x02, 0x01);    
    Inf_Si24R1_WriteReg(0x20 + 0x04, 0x0a);   
    Inf_Si24R1_WriteReg(0x20 + 0x05, 99);          
    Inf_Si24R1_WriteReg(0x20 + 0x06, 0x0f);     
    Inf_Si24R1_WriteReg(0x20 + 0x00, 0x0e);       
     
    HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), ((uint16_t)0x0100), GPIO_PIN_SET);
}
...
void Inf_Si24R1_RXMode(void)
{
    ...
    Inf_Si24R1_WriteReg(0x20 + 0x02, 0x01);                        
    Inf_Si24R1_WriteReg(0x20 + 0x05, 99);                              
    Inf_Si24R1_WriteReg(0x20 + 0x11, 18);               
    Inf_Si24R1_WriteReg(0x20 + 0x06, 0x0f);                         
    Inf_Si24R1_WriteReg(0x20 + 0x00, 0x0f);                           
    HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), ((uint16_t)0x0100), GPIO_PIN_SET);                                                           
}
...
uint8_t Inf_Si24R1_TxPacket(uint8_t *txBuf)
{
    ...
    HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), ((uint16_t)0x0100), GPIO_PIN_RESET);
    Inf_Si24R1_WriteBuf(0xA0, txBuf, 18);
    HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), ((uint16_t)0x0100), GPIO_PIN_SET);   

     
    while(!(state & (0x20 | 0x10)))
    {
        state = Inf_Si24R1_ReadReg(0x00 + 0x07);
    }

     
    Inf_Si24R1_WriteReg(0x20 + 0x07, state);
...
uint8_t Inf_Si24R1_RxPacket(uint8_t *rxBuf)
{
    ...
    if(state & 0x40)
    {
        ...
        Inf_Si24R1_ReadBuf(0x61, rxBuf, 18);
         
        Inf_Si24R1_WriteReg(0xE2, 0xff);
...
uint8_t Inf_Si24R1_Check(void)
{
    ...
    Inf_Si24R1_WriteBuf(0x20 + 0x10, buff_w, 5);

     
    Inf_Si24R1_ReadBuf(0x00 + 0x10, buff_r, 5);
