...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), ((uint16_t)0x0010)|((uint16_t)0x0100), GPIO_PIN_SET);

   
  HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000C00UL)), ((uint16_t)0x0004), GPIO_PIN_SET);

   
  HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000C00UL)), ((uint16_t)0x4000)|((uint16_t)0x8000), GPIO_PIN_RESET);

   
  HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), ((uint16_t)0x0800)|((uint16_t)0x1000), GPIO_PIN_RESET);

   
  GPIO_InitStruct.Pin = ((uint16_t)0x0010)|((uint16_t)0x0100)|((uint16_t)0x0800)|((uint16_t)0x1000);
