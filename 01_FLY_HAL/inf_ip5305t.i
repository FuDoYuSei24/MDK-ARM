#line 1 "..\\Inf\\power\\Inf_IP5305T.c"
...
#line 2 "..\\Inf\\power\\Inf_IP5305T.c"


static void Inf_IP5305T_ShortPress(void){
    
    HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000C00UL)), ((uint16_t)0x0004), GPIO_PIN_RESET);
    
    
    
    vTaskDelay(100);
    
    HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000C00UL)), ((uint16_t)0x0004), GPIO_PIN_SET);
}
