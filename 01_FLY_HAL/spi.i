...
void MX_SPI1_Init(void)
{
  ...
  hspi1.Init.BaudRatePrescaler = ((0x1UL << (3U)));
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  if(spiHandle->Instance==((SPI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00003000UL)))
  {
   

   
     
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB2ENR) |= ((0x1UL << (12U)))); tmpreg = ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB2ENR) & ((0x1UL << (12U)))); (void)tmpreg; } while(0U);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  if(spiHandle->Instance==((SPI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00003000UL)))
  {
    ...
    (((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB2ENR &= ~((0x1UL << (12U))));
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), ((uint16_t)0x0020)|((uint16_t)0x0040)|((uint16_t)0x0080));
