...
void Inf_Motor_Init(void){
    ...
    HAL_TIM_PWM_Start(&htim4,0x0000000CU);
    HAL_TIM_PWM_Start(&htim2,0x00000004U);
    HAL_TIM_PWM_Start(&htim1,0x00000008U);
...
void Inf_MOtor_SetSpeed(Motor_Struct *motor){
    ...
    motor->speed = (motor->speed) >= (1000) ? (1000) : ( (motor->speed) <= (0) ? (0) : (motor->speed) );
    
    if(motor->location==LEFT_TOP){
        
        
        (((0x00000000U) == 0x00000000U) ? ((&htim3)->Instance ->CCR1 = (motor->speed)) : ((0x00000000U) == 0x00000004U) ? ((&htim3)->Instance ->CCR2 = (motor->speed)) : ((0x00000000U) == 0x00000008U) ? ((&htim3)->Instance ->CCR3 = (motor->speed)) : ((&htim3)->Instance ->CCR4 = (motor->speed)));
    }
    else if(motor->location==LEFT_BOTTOM)
    {
        
        (((0x0000000CU) == 0x00000000U) ? ((&htim4)->Instance ->CCR1 = (motor->speed)) : ((0x0000000CU) == 0x00000004U) ? ((&htim4)->Instance ->CCR2 = (motor->speed)) : ((0x0000000CU) == 0x00000008U) ? ((&htim4)->Instance ->CCR3 = (motor->speed)) : ((&htim4)->Instance ->CCR4 = (motor->speed)));
    }
    else if(motor->location==RIGHT_TOP)
    {
        
        (((0x00000004U) == 0x00000000U) ? ((&htim2)->Instance ->CCR1 = (motor->speed)) : ((0x00000004U) == 0x00000004U) ? ((&htim2)->Instance ->CCR2 = (motor->speed)) : ((0x00000004U) == 0x00000008U) ? ((&htim2)->Instance ->CCR3 = (motor->speed)) : ((&htim2)->Instance ->CCR4 = (motor->speed)));
    }
    else if(motor->location==RIGHT_BOTTOM)
    {
        
        (((0x00000008U) == 0x00000000U) ? ((&htim1)->Instance ->CCR1 = (motor->speed)) : ((0x00000008U) == 0x00000004U) ? ((&htim1)->Instance ->CCR2 = (motor->speed)) : ((0x00000008U) == 0x00000008U) ? ((&htim1)->Instance ->CCR3 = (motor->speed)) : ((&htim1)->Instance ->CCR4 = (motor->speed)));
    }
}
