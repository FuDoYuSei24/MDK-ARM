#line 1 "..\\App\\flight\\App_Flight.c"
...
#line 2 "..\\App\\flight\\App_Flight.c"


void App_Flight_Start(void){
    
    
    printf("[%15s:%4d] -- " "motor init start..." "\r\n", strrchr("..\\App\\flight\\App_Flight.c", '\\') ? (strrchr("..\\App\\flight\\App_Flight.c", '\\') + 1) : "..\\App\\flight\\App_Flight.c", 7 );
    Inf_Motor_Init();
    printf("[%15s:%4d] -- " "motor init complete..." "\r\n", strrchr("..\\App\\flight\\App_Flight.c", '\\') ? (strrchr("..\\App\\flight\\App_Flight.c", '\\') + 1) : "..\\App\\flight\\App_Flight.c", 9 );
}
